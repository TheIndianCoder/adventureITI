...
@push('title')
    <title>Add Gallery Image | Adventure Pvt. Ltd. </title>
@endpush
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input placeholder="Image Title" name="title" type="text" class="form-control" required>
                                            @error('title')
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <textarea placeholder="Course Details" name="details" class="form-control" rows="5"></textarea>
                                        </div>
                                    </div>
                                    <div class="col-lg-12 col-md-12 col-sm-12">
